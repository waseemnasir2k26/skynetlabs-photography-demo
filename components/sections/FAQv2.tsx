...
export function FAQv2() {
  ...
  return (
    <section className="py-16 md:py-24" style={{ background: "var(--bg, #fff)" }}>
      <script
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl">
          ...
          <div style={{ borderTop: "1px solid var(--hairline-mid, rgba(0,0,0,0.1))" }}>
            {faqs.map((f, i) => (
              <div key={i} style={{ borderBottom: "1px solid var(--hairline-mid, rgba(0,0,0,0.1))" }}>
                <button
                  type="button"
